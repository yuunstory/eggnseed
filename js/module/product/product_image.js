        ...
        var roll = {
            init : function(){
                function struct(){
                    ...
                    listWrap.append('<button type="button" class="prev transition4s"><i class="xi-angle-left-min"></i></button>');
                    listWrap.append('<button type="button" class="next transition4s"><i class="xi-angle-right-min"></i></button>');
                    ul.css({'position':'absolute', 'left':0, 'top':0, 'width':ulWidth + 2});
                    listWrap.find('> ul > li').each(function(){
                        $(this).css({'float':'left'});
                    });
                    listWrap.css({'position':'relative', 'height':liHeight - 1});
